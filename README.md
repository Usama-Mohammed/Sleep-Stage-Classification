...
The hypnogram below compares:

- Expert-labeled sleep stages (Ground Truth)
- Predicted sleep stages generated by the CNN-LSTM model
- Epoch-level agreement between predictions and annotations

This visualization demonstrates the temporal behavior of sleep stage transitions across the recording.

<p align="center">
  <img src="images/hypnogram.png" width="95%">
</p>

### Hypnogram Insights

- Overall epoch agreement reached approximately **79.5%**
- The model successfully captured major sleep stage transitions
- Strong agreement observed in:
  - Wake
  - Stage 2
  - REM
...
- Transitional stages such as Stage 1 remain difficult to classify
- Some confusion exists between:
  - Stage 1 and REM
  - Stage 1 and Stage 2

The hypnogram highlights both the temporal consistency and the limitations of the model during overnight sleep staging.
